	...
	<view class="container">
		<view class="carousel">
			<swiper indicator-dots circular=true duration="400" v-show="!showVideo">
				<swiper-item class="swiper-item" v-for="(item,index) in imgList" :key="item.image_id">
	...
	methods: {
		...
		toggleVideo (isShow) {
			...
			if (isShow === true) {
				...
				that.videoContext && that.videoContext.seek(0) && that.videoContext.stop();
			}
		},
		/**
		 * 规格弹窗开关
